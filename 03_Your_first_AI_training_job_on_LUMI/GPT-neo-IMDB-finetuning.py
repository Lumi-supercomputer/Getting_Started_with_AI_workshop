...
training_args = TrainingArguments(
    ...
    save_strategy="no",  # TODO: transformers bug causes crash while saving checkpoints in multinode scenarios (pre 4.40, https://github.com/huggingface/transformers/issues/28119)
