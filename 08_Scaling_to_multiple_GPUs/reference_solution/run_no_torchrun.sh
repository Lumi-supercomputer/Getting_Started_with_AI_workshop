...
srun --cpu-bind=v,mask_cpu=$CPU_BIND_MASKS \  # tell slurm to configure the cpu binds specified by the mask, additional option v prints to configuration to the logs
